...
class BukuSeeder extends Seeder
{
    ...
    private function createManuscripts()
    {
        $manuscripts = [
            [
                ...
                'sinopsis' => 'Buku komprehensif yang membahas dasar-dasar Laravel framework dengan contoh praktis dan studi kasus.',
                'genre' => 'Programming',
                'status' => 'approved',
                'info_tambahan' => ['halaman' => 350, 'target_pembaca' => 'Pemrogram Pemula']
            ],
            [
                'judul_naskah' => 'React.js: Modern Web Development',
                'sinopsis' => 'Pelajari React.js dari dasar hingga advanced dengan hooks, context, dan state management.',
                'genre' => 'Web Development',
                'status' => 'review',
                'info_tambahan' => ['halaman' => 280, 'target_pembaca' => 'Web Developer']
            ],
            [
                'judul_naskah' => 'Database Design Principles',
                'sinopsis' => 'Prinsip-prinsip desain database yang baik untuk aplikasi skala kecil hingga enterprise.',
                'genre' => 'Database',
                'status' => 'approved',
                'info_tambahan' => ['halaman' => 400, 'target_pembaca' => 'Database Administrator']
            ],
            [
                'judul_naskah' => 'UI/UX Design Fundamentals',
                'sinopsis' => 'Fundamental desain UI/UX yang wajib diketahui oleh setiap designer dan developer.',
                'genre' => 'Design',
                'status' => 'draft',
                'info_tambahan' => ['halaman' => 320, 'target_pembaca' => 'UI/UX Designer']
            ],
            [
                'judul_naskah' => 'Python for Data Science',
                'sinopsis' => 'Python programming untuk analisis data dan machine learning.',
                'genre' => 'Data Science',
                'status' => 'cancelled',
                'info_tambahan' => ['halaman' => 450, 'target_pembaca' => 'Data Scientist']
            ]
        ];
        ...
        foreach ($manuscripts as $manuscript) {
            $createdManuscript = Manuscript::firstOrCreate(
                ...
                array_merge($manuscript, [
                    'penulis_user_id' => User::where('email', 'penulis@bps.com')->first()->user_id,
    ...
    private function createBooks()
    {
        ...
        $books = [
            [
                ...
                'pic_user_id' => User::where('email', 'manajer@bps.com')->first()->user_id,
            ...
            [
                ...
                'pic_user_id' => User::where('email', 'produksi@bps.com')->first()->user_id,
                'penerbit_id' => $publishers['Elex Media Komputindo'],
    ...
    private function createTaskProgress()
    {
        ...
        $taskProgress = [
            ...
            // Book 2 - Review (50% complete - task 1-8 selesai)
            [
            ...
            [
                ...
                'catatan' => 'QC isi sedang berlangsung'
            ],

            // Book 3 - Editing (30% complete - task 1-5 selesai)
            [
            ...
            [
                ...
                'catatan' => 'Layout sedang berlangsung'
            ],

            // Book 4 - Draft (10% complete - task 1-2 selesai)
            [
            ...
            [
                ...
                'catatan' => 'Pengantar dan endors sedang berlangsung'
            ],

            // Book 5 - Cancelled (0% complete)
            [
